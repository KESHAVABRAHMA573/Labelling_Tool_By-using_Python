...
#----------------------------------------------------
    ...
    def start_zoom_rect(self, event):
        ...
        self.zoom_rect_id = self.canvas.create_rectangle(*self.zoom_start, *self.zoom_start, outline="green",width=2)
    ...
    def savePressed(self, force=False):
        ...
        if not self.image_saved_once:
            ...
            msg = f"Saved as: {', '.join(main_formats)}"
            if "PNG" in saved_formats:
                msg += " + PNG"
